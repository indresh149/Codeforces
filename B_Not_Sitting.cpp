    ...
    for(int i=0;i<n;i++){
        for(int j=0;j<m;j++){
            ...
            else if(n%2 == 0 && m%2 == 0)
            {
                ...
                ll d = min(abs(i-a1)+abs(j-b1),abs(i-a2)+abs(j-b2));

                d = min(d,abs(i-a1)+abs(j-b2));
                d = min(d,abs(i-a2)+abs(j-b1));
                st.insert(s+d);
            ...
            else if(n%2 == 0)
            {
                ...
                ll a2 = n/2-1;
                ll b = m/2;
                ll d = min(abs(i-a1)+abs(j-b),abs(i-a2)+abs(j-b));
                st.insert(s+d);
            }
            else if(m%2 == 0)
            {
                ...
                ll b1 = m/2;
                ll b2 = m/2-1;
                ll d = min(abs(i-a)+abs(j-b1),abs(i-a)+abs(j-b2));
                st.insert(s+d);
            }
        }
    }
