...
unsigned long long sumFactorial(vector<unsigned long long> arr, unsigned long long n)
{
...
// unsigned long long sum = sumFactorial(a,n);

// unsigned long long res = factorial(x);
...
fl(i,n)
    ...
    { 
        ...
        facts[i + 1] = facts[i + 1] + facts[i]/(i + 1); 
