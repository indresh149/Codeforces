...
sort(jarurat.begin(),jarurat.end());
...
for(ll x = 1;x <= n;x++)
{
    ...
    // cout<<x<<endl;
    if(ans < jarurat.size() && x >= jarurat[ans].ff)
    {


// cout<<x<<" "<<jarurat[ans].ff<<" "<<jarurat[ans].ss<<endl;
        cout<<jarurat[ans].ss + 1<<" ";
