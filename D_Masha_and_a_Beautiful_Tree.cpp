...
pair<ll,ll> f(ll left,ll right,vector<ll> &hv,ll &h)
{

    if(left==right)
    {
        // cout<<left<<" "<<right<<" "<<hv[left]<<endl;


        return {hv[left],hv[right]};
    }
  ...
  //  cout<<d<<endl;
    ...
    pair<ll,ll> p1 = f(left,d,hv,h);

    // cout<<p1.ff<<" "<<p1.ss<<endl;
    pair<ll,ll> p2 = f(d+1,right,hv,h);
   ...
   //     cout<<h<<endl;
    ...
    if(p1.ss == p2.ff - 1 && p2.ss - p1.ff == (right-left))
    {
